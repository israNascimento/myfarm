    ...
    return(
        <Container style={{paddingTop: Platform.OS === 'ios' ? 0 : StatusBar.currentHeight}}>
          <Header>
              ...
              <Body><Text style={{color:Platform.OS === 'ios' ? "black" : "white",width:200}}>Cadastro de colheitas</Text></Body>
              <Right />
          </Header>
          ...
          <Content style={{backgroundColor:'#eee',padding:15}}>
              ...
              <Text style={{fontSize:14,color:'#444', marginBottom:8,marginLeft:5}}>Registro da produção diária.</Text>
              ...
              <Button block style={{marginTop: 15,marginBottom:25}} onPress={()=>{
                  ...
                  let data = new Date();
                  registraHistorico("colheitas",{time: data.getDate() + "/" + (data.getMonth() + 1) + "/" + data.getYear(), title: tmp.quantidade + " tomates coletados", description: tmp.producao});
